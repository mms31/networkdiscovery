...
class IpaddressesControllerTest < ActionController::TestCase
  ...
  test "should create ipaddress" do
    assert_difference('Ipaddress.count') do
      post :create, ipaddress: { ipaddress: @ipaddress.ipaddress, iprange: @ipaddress.iprange, pingable: @ipaddress.pingable }
    end
  ...
  test "should update ipaddress" do
    patch :update, id: @ipaddress, ipaddress: { ipaddress: @ipaddress.ipaddress, iprange: @ipaddress.iprange, pingable: @ipaddress.pingable }
    assert_redirected_to ipaddress_path(assigns(:ipaddress))
  end
